...
<main class="bg-white min-h-screen">
    ...
    <div class="relative bg-green-800 py-24 overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10 text-center" data-aos="fade-down">
            ...
            <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-6 tracking-tight leading-none">
                    ...
                    @forelse ($galeris as $index => $galeri)
                        <div class="group relative bg-white rounded-[2.5rem] shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-green-100" 
                            ...
                            <div class="relative h-80 overflow-hidden">
                                ...
                                <div class="absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-all duration-700 -translate-y-4 group-hover:translate-y-0">
                            ...
                            <div class="p-10 relative bg-white flex flex-col h-full">
                                <div class="flex items-center justify-between mb-4">
                                    <p class="text-[10px] font-black text-green-600/60 uppercase tracking-[0.3em]">Momen Dokumentasi</p>
                                    <div class="w-8 h-[2px] bg-yellow-400 rounded-full"></div>
                                </div>
                                <h3 class="text-2xl font-black text-gray-900 leading-tight group-hover:text-green-800 transition-colors mb-4">
                                    {{ $galeri->judul }}
                                </h3>
                                <p class="text-gray-500 text-sm font-medium leading-relaxed italic line-clamp-3">
