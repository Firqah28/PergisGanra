...
<div class="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow mt-10">
    ...
    <form action="{{ route('guru.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama" id="nama" class="mt-1 block w-full rounded border-gray-300" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="mata_pelajaran" id="mata_pelajaran" class="mt-1 block w-full rounded border-gray-300" required>
        </div>

        <div class="mb-4">
            <label for="deskripsi" class="block text-sm font-medium text-gray-700">Deskripsi</label>
            <textarea name="deskripsi" id="deskripsi" rows="3" class="mt-1 block w-full rounded border-gray-300"></textarea>
        </div>

        <div class="mb-4">
            <label for="prestasi" class="block text-sm font-medium text-gray-700">Prestasi (pisahkan dengan koma)</label>
            <textarea name="prestasi" id="prestasi" rows="3" class="mt-1 block w-full rounded border-gray-300"></textarea>
        </div>
