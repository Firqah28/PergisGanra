...
<main class="bg-gray-50 min-h-screen pb-24">
    ...
    <div class="container mx-auto px-4 -mt-12 relative z-20">
        <div class="max-w-4xl mx-auto">
            <!-- Intro Card -->
            <div class="bg-white rounded-3xl shadow-xl p-8 md:p-12 mb-12 border-b-8 border-green-800" data-aos="fade-up">
                <div class="flex flex-col md:flex-row gap-8 items-center">
                    <div class="w-full md:w-1/3">
                        <div class="relative">
                            <img src="/image/background3.jpg" alt="Sejarah" class="rounded-2xl shadow-lg w-full h-64 object-cover">
                            <div class="absolute -bottom-4 -right-4 bg-yellow-500 text-green-900 font-black px-6 py-3 rounded-xl shadow-lg">
                                EST. 2005
                            </div>
                        </div>
                    </div>
                    <div class="w-full md:w-2/3 space-y-4">
                        <h3 class="text-2xl font-bold text-green-800">Awal Perjuangan</h3>
            ...
            <div class="space-y-8">
                ...
                <!-- 2005 Milestone -->
                <div class="flex gap-6 items-start group" data-aos="fade-left">
                    <div class="flex-shrink-0 w-16 h-16 bg-white shadow-lg rounded-2xl flex items-center justify-center border-t-4 border-yellow-500 transform group-hover:scale-110 transition-transform">
                        <span class="text-green-800 font-black text-xl">2005</span>
                    </div>
                    <div class="bg-white rounded-2xl shadow-md p-6 flex-grow border-l-4 border-green-800">
                        <h4 class="text-xl font-extrabold text-gray-900 mb-2">Resmi Beroperasi</h4>
                ...
                <div class="flex gap-6 items-start group" data-aos="fade-left" data-aos-delay="100">
                    <div class="flex-shrink-0 w-16 h-16 bg-white shadow-lg rounded-2xl flex items-center justify-center border-t-4 border-yellow-500 transform group-hover:scale-110 transition-transform">
                        <i class="fas fa-chart-line text-green-800 text-2xl"></i>
                    </div>
                    <div class="bg-white rounded-2xl shadow-md p-6 flex-grow border-l-4 border-green-800">
                        <h4 class="text-xl font-extrabold text-gray-900 mb-2">Pertumbuhan & Kepercayaan</h4>
                        <p class="text-gray-600 leading-relaxed">
                            Berkat dukungan penuh dari masyarakat dan kerja keras tenaga pendidik yang berdedikasi, Madrasah ini terus berkembang, meningkatkan fasilitas, dan meraih berbagai prestasi di tingkat daerah.
                        </p>
                    </div>
                </div>

                <!-- Modern Era Milestone -->
                <div class="flex gap-6 items-start group" data-aos="fade-left" data-aos-delay="200">
                    <div class="flex-shrink-0 w-16 h-16 bg-green-900 shadow-xl rounded-2xl flex items-center justify-center border-t-4 border-yellow-500 transform group-hover:scale-110 transition-transform">
                        <i class="fas fa-graduation-cap text-yellow-500 text-2xl"></i>
                    </div>
                    <div class="bg-green-900 rounded-2xl shadow-md p-6 flex-grow text-white">
                        <h4 class="text-xl font-extrabold text-yellow-400 mb-2">Masa Depan Unggul</h4>
                        <p class="text-green-50 leading-relaxed">
                            Kini, MA Pergis Ganra terus bertransformasi menuju integrasi IPTEK dan IMTAQ yang lebih mendalam, mempersiapkan lulusan untuk menghadapi tantangan zaman dengan bekal akhlak mulia.
                        </p>
                    </div>
                </div>
            </div>
