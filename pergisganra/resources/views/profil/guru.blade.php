...
<main class="bg-white min-h-screen">
    ...
    <section class="py-24 bg-gray-50 relative overflow-hidden">
        <div class="container mx-auto px-4 relative z-10">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
                ...
                <div 
                    class="group relative bg-white rounded-[2.5rem] p-10 flex flex-col items-center text-center shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-green-50 hover:border-green-400 cursor-pointer"
                    data-nama="{{ $guru->nama }}"
                ...
                >
                    ...
                    <div class="relative mb-8">
                        ...
                        <div class="relative w-36 h-36 rounded-full p-1.5 bg-gradient-to-br from-green-600 to-yellow-500 group-hover:rotate-6 transition-transform duration-500">
                    ...
                    <div class="space-y-4">
                        <div class="space-y-1">
                            <p class="text-[10px] font-black text-green-600 uppercase tracking-[0.3em] opacity-80 group-hover:text-yellow-600 transition-colors">Tenaga Pendidik</p>
                            <h3 class="text-2xl font-black text-gray-900 leading-tight group-hover:text-green-800 transition-colors">
                                {{ $guru->nama }}
                            </h3>
                        </div>
                        <div class="inline-block px-4 py-1.5 bg-green-50 text-green-800 rounded-full text-xs font-bold border border-green-100 group-hover:bg-green-800 group-hover:text-white transition-all">
                            {{ $guru->mata_pelajaran }}
                        </div>
                    </div>
    ...
    <div id="guruModal" class="fixed inset-0 bg-green-950/80 backdrop-blur-sm flex justify-center items-center opacity-0 pointer-events-none transition-all duration-300 z-50 p-4">
        <div class="bg-white rounded-[3rem] shadow-2xl max-w-2xl w-full relative overflow-hidden transform scale-95 transition-transform duration-300" id="modalContainer">
            <!-- Close Button -->
            <button onclick="closeModal()" class="absolute top-6 right-6 w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center text-gray-400 hover:bg-red-500 hover:text-white transition-all z-20 group">
                <i class="fas fa-times text-2xl"></i>
            </button>

            <div class="flex flex-col md:flex-row min-h-[400px]">
                <!-- Left: Photo side -->
                <div class="md:w-2/5 bg-green-800 p-12 flex flex-col items-center justify-center relative">
                    <!-- Overlay Pattern -->
                    ...
                    <div class="relative group">
                        ...
                        <img id="modalFoto" src="" alt="" class="w-40 h-40 object-cover rounded-full border-4 border-white shadow-2xl relative z-10">
                    </div>
                </div>
                ...
                <div class="md:w-3/5 p-12 flex flex-col justify-center">
                    <div class="mb-8">
                        <p class="text-xs font-black text-yellow-600 uppercase tracking-[0.3em] mb-2">Profil Pendidik</p>
                        <h3 id="modalNama" class="text-3xl font-black text-green-900 leading-tight mb-2"></h3>
                        <div class="inline-block px-4 py-1.5 bg-green-100 text-green-800 rounded-full text-xs font-bold border border-green-200">
                            <span id="modalMapel"></span>
                        </div>
                    </div>
                    
                    <div class="relative">
                        <i class="fas fa-quote-left text-green-100 text-4xl absolute -top-4 -left-2 -z-0"></i>
                        <p id="modalDeskripsi" class="text-gray-700 leading-relaxed font-medium relative z-10"></p>
                    </div>
